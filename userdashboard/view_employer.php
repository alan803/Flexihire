    ...
    <div class="dashboard-container">
        ...
        <div class="main-content">
            <div class="page-header">
                ...
                <a href="manage_employers.php" class="back-btn">
                    <i class="fas fa-arrow-left"></i> Back to Employers
                </a>
            </div>
                ...
                <div class="user-profile">
                    <div class="profile-header">
                        ...
                        <div class="profile-info">
                            ...
                            <p class="email"><?= htmlspecialchars($employer['email']) ?></p>
                            <span class="status-badge <?= strtolower($employer['status']) === 'active' ? 'active' : 'inactive' ?>">
                    ...
                    <div class="user-details">
                        <div class="detail-card">
                            <h3>Phone Number</h3>
                            <p><?= htmlspecialchars($employer['phone_number'] ?? 'Not provided') ?></p>
                        </div>
                        <div class="detail-card">
                            <h3>Address</h3>
                        ...
                        <div class="detail-card">
                            ...
                            <p><?= htmlspecialchars($employer['establishment_year'] ?? 'Not provided') ?></p>
                        </div>
                        <div class="detail-card">
                            <h3>Joined Date</h3>
