<?php
    ...
    $sql = "UPDATE tbl_jobs SET status = 'approved' WHERE job_id = ?";
    $stmt = mysqli_prepare($conn, $sql);
    mysqli_stmt_bind_param($stmt, "i", $job_id);
    
    if(mysqli_stmt_execute($stmt)) 
    {
        $_SESSION['message'] = "Job has been successfully approved.";
        $_SESSION['message_type'] = "success";
    } 
    else 
    {
        $_SESSION['message'] = "Error approving the job. Please try again.";
        $_SESSION['message_type'] = "error";
    }
